...
\begin{document}
	...
	\subsection{Descrizione}
	In questa sezione verrà discussa la compatibilità delle tecnologie utilizzate con i browser adottati per testare il sito. Il sito è stato realizzato seguendo in parte le specifiche HTML5, concordando sull'utilizzo  di specifici tag relativi a questa versione HTML.
	\subsection{Tag HTML5 utilizzati}
	\begin{itemize}
		\item \textbf{<header>}: questo tag è stato utilizzato nella home page e nella pagina about per inserire il titolo e un'immagine di copertina associata al nostro sito e ai suo target. Risulta ben supportato dai principali browser.
		\item \textbf{<footer>}: questa sezione è stata inserita in tutte le pagine informative con lo scopo di fornire informazioni aggiuntive relative a sviluppatori e committente. Anche questo risulta ben supportato come il precedente.
